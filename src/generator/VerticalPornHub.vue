...
<template>
    <div class="pornhub">
        <div class="box" v-tooltip="{content:'点击可编辑文字', show: true, classes: 'tooltipClasses'}">
        ...
        <div class="customize">
          ...
          >
            <div>文字颜色: &nbsp; <input type="color" v-model="prefixColor" /></div>
            <div>高亮文字颜色: &nbsp; <input type="color" v-model="suffixColor" /></div>
          ...
          <div class="customize-misc">
            <div>
              文字大小: <input type="range" min="30" max="200" v-model="fontSize" /> {{ fontSize }}px
            </div>
            <div>高亮反转: <input type="checkbox" v-model="reverseHighlight" /></div>
          </div>
        </div>
        ...
        <div class="download-share">
          <div
            class="download"
            v-tooltip="{ content: '导出图标', show: true, classes: 'tooltipClasses' }"
            @click="download"
          >
            导出
          </div>
